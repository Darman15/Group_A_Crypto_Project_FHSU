...
public class RSA {
    ...
    // E is the public exponent (shared with Jim); D is the private exponent kept secret by Pam.
    public static final BigInteger P;
    public static final BigInteger Q;
    public static final BigInteger N;
    public static final BigInteger PHI;
    ...
    // Jim calls this with Pam's public key (E, N) to encrypt the DES key.
    public static BigInteger encrypt(BigInteger key, BigInteger pubE, BigInteger modulus) {
        return key.modPow(pubE, modulus);
    }

    // RSA decryption: plain = cipher^privD mod modulus.
    // Pam calls this with her private key (D, N) to recover the DES key.
    public static BigInteger decrypt(BigInteger cipher, BigInteger privD, BigInteger modulus) {
        return cipher.modPow(privD, modulus);
    }
